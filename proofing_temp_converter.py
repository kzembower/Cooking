"""proofing_temp_converter.py
    ...
    range needed for proofing dough temperatures.

    Modified by Kevin Zembower, kevin@zembower.org

    Version 0.1 created 16 Nov 2025, from
    oven_proofing_temp_converter.py

To create the .pdf file output, you must be in the directory in which
this file is stored, in a python3 virtual environment ('source
.venv/bin/activate'). Then run `python3 proofing_temp_converter.py'.
...
main_params={
    'filename':'proofing_temp_converter.pdf',
    'paper_height':15.0,
    'paper_width':2.0,
    ...
    'title_y':-1,
    'title_box_width':7,
    'title_str':r'\Large Proofing Temperature Conversions',
    'extra_texts':[
        # {'x':-1.5,
        #  'y':-2.0,
        ...
        {'x':-1.5,
         'y':-2.0,
         'text':r'Optimal proofing\
         between 26-27 degree C.',
         'width':7.2,
         },
        {'x':-1.5,
         'y':-2.5,
